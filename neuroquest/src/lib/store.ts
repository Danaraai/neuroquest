...
const initialState: UserState = {
  ...
  worldProgress: {
    ...
    world2: { worldId: "world2", unlocked: false, completed: false },
    world3: { worldId: "world3", unlocked: false, completed: false },
    world4: { worldId: "world4", unlocked: false, completed: false },
    world5: { worldId: "world5", unlocked: false, completed: false },
  },
  srCards: {},
