            ...
            questions: [
              {
                ...
                correctIndex: 1,
                explanation: "═══ IndexError — The Off-By-One Mistake ═══\n\n📍 PYTHON COUNTS FROM 0, NOT 1\n\nYour list: spike_times = [10, 25, 42]\n           Index:          0   1   2\n\nValid indices: 0, 1, 2\nInvalid: 3 (doesn't exist!)\n\n━━━ WHAT HAPPENS ━━━\nspike_times[0]  ✓ gives 10\nspike_times[1]  ✓ gives 25\nspike_times[2]  ✓ gives 42\nspike_times[3]  ✗ IndexError!\n\n━━━ THE MISTAKE ━━━\nThis is called the \"off-by-one\" error—the #1 bug beginners make. You think \"3 items, use index 3\" but Python counts 0, 1, 2.\n\n━━━ HOW TO FIX IT ━━━\nTo get the LAST item without counting:\n  spike_times[-1]   ← Use -1 (means \"last\")\n  spike_times[-2]   ← Use -2 (means \"second to last\")\n\nThis is a clever trick that works in NMA code:\n  spikes = [10, 25, 42, 67, 89]\n  last_spike = spikes[-1]  ← Gets 89 without knowing the length!\n\n💡 REMEMBER: Python always starts at 0, not 1!",
              },
              {
                id: "w1q7l1q2",
                ...
                correctIndex: 1,
                explanation: "═══ Print vs Return — A Critical Difference ═══\n\n🍽️ MENTAL MODEL: Restaurant Analogy\n\nprint(rate) = Waiter SHOUTS the answer\n  → Everyone in the restaurant hears it\n  → But you don't GET anything\n\nreturn rate = Waiter HANDS YOU the plate\n  → Only you get it\n  → You can use it for the next step\n\n━━━ WHAT HAPPENS WITH print() ━━━\nresult = firing_rate(42, 1000)  # Function only prints 0.042\nprint(result)  # → None (nothing was handed back!)\n\n━━━ WHAT HAPPENS WITH return ━━━\nresult = firing_rate(42, 1000)  # Function returns 0.042\nprint(result)  # → 0.042 (the value is now usable!)\n\n━━━ THE KEY INSIGHT ━━━\nprint()  = Shows something on screen for HUMANS to see\nreturn   = Gives something to CODE to use\n\nWhen you store: result = firing_rate(...)\nPython asks: \"Where's the value I should put in result?\"\n\nIf you only print, result = None (nothing!)\nIf you return, result = 0.042 (usable!)\n\n━━━ THE FIX ━━━\nChange: print(rate)\nTo:     return rate\n\n💡 NMA CRITICAL:\nEvery computation function MUST return its value. In neural simulations, you chain functions: compute voltage → use it to check spikes → use that result in next iteration. Without return, this breaks!",
              },
              {
                id: "w1q7l1q3",
                ...
                correctIndex: 1,
                explanation: "═══ The Colon (:) — Opening a Code Block ═══\n\n🚪 WHAT IT DOES:\nThe colon (:) tells Python: \"Everything indented after this IS PART OF this statement.\"\n\n━━━ CORRECT: With colon ━━━\nfor i in range(5):\n    print(i)         ← These lines are INSIDE\n    print('hi')      ← the for loop\nprint('done')        ← This is OUTSIDE (no indent)\n\nPython understands: i=0, print(0), print('hi'), then i=1, repeat...\n\n━━━ WRONG: Without colon ━━━\nfor i in range(5)    ← Missing colon!\n    print(i)         ← SyntaxError: invalid syntax\n\nPython says: \"You didn't tell me where the block starts!\"\n\n━━━ WHY IT MATTERS ━━━\nThe colon + indent = \"code block\"\n\nUsed everywhere:\n  for i in range(100):       ← Simulate 100 neurons\n  if V > threshold:          ← Check for spike\n  def compute_voltage(I):    ← Define a function\n\n💡 MUSCLE MEMORY:\nEvery time you write for, if, or def → TYPE THE COLON IMMEDIATELY\n\nIt's automatic in NMA code, so internalize it now!",
              },
              {
                id: "w1q7l1q4",
                text: "V = -70\nif V = -55:\n    print('threshold!')",
                ...
                correctIndex: 2,
                explanation: "═══ = vs == — The Most Common Python Mistake ═══\n\n👷 SINGLE = (assignment):\nStores a value INTO a variable\n  V = -55  ← Puts -55 into V\n\n⚖️ DOUBLE == (comparison):\nAsks: \"Are these equal?\"\n  if V == -55:  ← Asks: \"Is V equal to -55?\"\n\n━━━ MENTAL MODEL ━━━\n=  is a WORKER — it PUTS something IN\n== is a JUDGE — it ASKS if two things match\n\n━━━ WRONG vs RIGHT ━━━\nWRONG:\nif V = -55:       ← You're ASSIGNING\n    print('hi')\nSyntaxError!\n\nCORRECT:\nif V == -55:      ← You're COMPARING\n    print('hi')\nWorks!\n\nPython says: \"You can't ASSIGN in an if! Use comparison (==) instead!\"\n\n━━━ SIDE BY SIDE ━━━\nV = -70           ← Store -70 in V\nif V == -70:      ← Check: is V equal to -70?\n    print('rest') ← Yes! Print it\n\n💡 NMA CONSTANT:\nEvery neural simulation needs:\nif V > threshold:        ← Check voltage\nif spike_count == 0:     ← Check spike count\nif time == start_time:   ← Check time\n\nAlways use == to COMPARE. Use = to ASSIGN.",
              },
              {
                id: "w1q7l1q5",
                text: "import numpy as np\na = np.array([1, 2, 3])\nb = [4, 5, 6]\nprint(a + b)",
                ...
                correctIndex: 1,
                explanation: "═══ NumPy's Superpower: Element-Wise Operations ═══\n\n🧠 WHAT IS BROADCASTING?\nNumPy automatically performs math on EVERY element at once.\n\n━━━ THE CALCULATION ━━━\narr_a = [1, 2, 3]\narr_b = [4, 5, 6]\n\narr_a + arr_b\n  ↓ (element-wise addition)\n[1+4, 2+5, 3+6]\n  ↓\n[5, 7, 9]\n\nEach element matches up and gets added!\n\n━━━ PYTHON LIST vs NUMPY ARRAY ━━━\nPython list:\nlist_a = [1, 2, 3]\nlist_b = [4, 5, 6]\nlist_a + list_b  → [1, 2, 3, 4, 5, 6] (concatenates!)\n\nNumPy array:\narr_a = np.array([1, 2, 3])\narr_b = [4, 5, 6]\narr_a + arr_b  → [5, 7, 9] (adds element-wise!)\n\nCompletely different! With NumPy, + means math, not joining.\n\n━━━ WHY THIS MATTERS FOR NMA ━━━\nSimulating 100 neurons:\n\nWITHOUT NumPy:\nfor i in range(100):\n    V[i] = V[i] + dV_dt[i] * dt\n← Slow! Need a loop for each neuron\n\nWITH NumPy:\nV = V + dV_dt * dt\n← Fast! One line computes all 100 neurons!\n\n💡 THIS IS WHY NMA USES NUMPY\nElement-wise operations make code fast AND elegant. This single feature is why neuroscience uses NumPy for neural simulations.",
              },
            ],
          },
        ],
