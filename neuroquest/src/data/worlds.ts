        ...
        lessons: [
          {
            ...
            concept: [
              {
                type: "text",
                content: "A **for loop** repeats code for each item in a list (or range). In neuroscience, loops let you simulate each time step, or process each neuron.",
              },
              {
                type: "code",
                content: "# Loop over a spike train\nspike_times = [10, 25, 42, 67]\nfor t in spike_times:\n    print(f'Spike at {t} ms')\n\n# Output:\n# Spike at 10 ms\n# Spike at 25 ms\n# Spike at 42 ms\n# Spike at 67 ms",
                caption: "Each time through the loop, t takes the next value from the list.",
              },
              {
                type: "text",
                content: "**range()** generates a sequence of numbers:\n```python\nfor i in range(5):\n    print(i)  # prints 0, 1, 2, 3, 4\n\n# Simulate 1000 ms in 1 ms steps\nfor t in range(1000):\n    # update neuron state at time t\n    pass\n```",
              },
              {
                type: "highlight",
                content: "Indentation matters in Python! Code inside a loop MUST be indented (4 spaces or 1 tab). It's not optional.",
              },
            ],
          },
          {
            ...
            concept: [
              {
                type: "text",
                content: "An **if statement** makes decisions. It runs code only when a condition is True.",
              },
              {
                type: "code",
                content: "V = -52  # membrane voltage in mV\nthreshold = -55  # spike threshold\n\nif V > threshold:\n    print('Neuron fires! 🔥')\n    spike_times.append(t)\nelse:\n    print('Neuron is silent')",
                caption: "This is literally how a neuron spike threshold is implemented in NMA!",
              },
              {
                type: "code",
                content: "# Combining loop + if: count spikes\nspike_times = [10, 25, 42, 67, 89]\ncount = 0\nfor t in spike_times:\n    if t > 50:  # spikes after 50ms\n        count += 1\n\nprint(f'Late spikes: {count}')  # Late spikes: 2",
                caption: "count += 1 means count = count + 1. A shorthand for 'add 1 to count'.",
              },
            ],
          },
          {
